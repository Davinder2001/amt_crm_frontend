...
// const Sidebar: React.FC<sidebarProps> = ({ isSidebarExpanded, isMobile, openMenu }) => {
//   const { userType, companySlug } = useCompany();
//   const { data } = useFetchSelectedCompanyQuery();
...
//             <Link href={`${userType === 'employee'
//               ? `/${companySlug}/employee/dashboard`
//               : `/${companySlug}/dashboard`}`} className="logo-wrapper" onClick={openMenu}>
//               {company.company_logo ?
//                 <Image src={company.company_logo} alt="logo" width={30} height={30} /> :
//                 <>
...
//           <Link href={`${userType === 'employee'
//             ? `/${companySlug}/employee/dashboard`
//             : `/${companySlug}/dashboard`}`} className="logo-wrapper">
//             {company.company_logo ?
//               <Image src={company.company_logo} alt="logo" width={30} height={30} /> :
//               <>
//                 <Image src={logo.src} alt="logo" width={30} height={30} />
