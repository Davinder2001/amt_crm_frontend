...
import { useFetchEmployesQuery, useUpdateEmployeMutation } from '@/slices/employe/employeApi';
...
const EditUserPage: React.FC = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      ...
      router.push(`/${companySlug}/employee/hr/status-view`);  // Navigate to the users page after successful update
    } catch (err: unknown) {
