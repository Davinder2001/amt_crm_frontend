        ...
        actions={[
          {
            ...
            onClick: () => router.push(`/${companySlug}/employee/tasks/task-timeline`),
          },
          {
            label: 'Add Task',
            icon: <FaPlus />,
            onClick: () => router.push(`/${companySlug}/employee/tasks/add-task`),
          },
          {
            label: 'Attendance',
            icon: <FaUserCheck />,
            onClick: () => router.push(`/${companySlug}/employee/attendence`),
          },
          {
