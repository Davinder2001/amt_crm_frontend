        ...
        {type === "date" ? (
          ...
          <input
            ...
            onChange={(e) =>
              setFormData((prev) => ({
                ...prev,
                idProofImage: e.target.files?.[0] || null,
              }))
            }
          />
        )}
    ...
    <div className="employee-fields-wrapper">
      ...
      {formData.idProofType && formData.idProofType !== "bill" && (
        <div className="employee-field">
          ...
          />
          {errors.idProofValue && (
            <div className="text-red-500 text-sm">{errors.idProofValue}</div>
          )}
        </div>
      )}
      ...
      {formData.idProofType === "bill" && (
        <div className="employee-field">
          ...
          />
          {errors.idProofImage && (
            <div className="text-red-500 text-sm">{errors.idProofImage}</div>
          )}
        </div>
      )}
