...
const EmployeeForm: React.FC<EmployeeFormProps> = ({ mode = "add", employeeId }) => {
    ...
    useEffect(() => {
        if (mode === "edit" && employeeId && employeeData) {
            ...
            const formValues = {
                ...
                ...employee.employee_details,
                role: employee.roles?.[0]?.name || '',
                utility_bill_image: typeof employee.employee_details?.utility_bill_image === 'string'
                    ? null
                    : employee.employee_details?.utility_bill_image ?? null,
            };
            setFormData(formValues);
            setOriginalData(formValues);
            ...
            if (employee.employee_details?.addressProof) {
                setAddressProofImagePreview(employee.employee_details.addressProof);
            }
            if (employee.employee_details?.utility_bill_image) {
                setUtilityBillImagePreview(employee.employee_details.utility_bill_image);
            }
        } else if (mode === "add") {
            const saved = localStorage.getItem(LOCAL_STORAGE_KEY);
            if (saved) {
                ...
                // Handle image previews from localStorage if needed
                // Note: File objects can't be stored in localStorage, so you'd need a different approach
            }
            setHasLoadedFromLS(true);
        }
    }, [mode, employeeId, employeeData]);
    ...
    const handleCancelChanges = () => {
        setFormData(originalData);
        setHasChanges(false);
        // Reset image previews to original values if needed
    };
            ...
            <div className="form-content-wrapper">
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-main-content">
                        ...
                        <div className="form-card">
                            <h3 className="form-card-title">
                                <FaBriefcase className="icon" /> Job Information
                            </h3>
                            <div className="form-card-content">
                                <div className="form-grid">
                                    {renderField("Email", "email", "email", "Enter email address", FaEnvelope)}
                        ...
                        <div className="form-card">
                            <h3 className="form-card-title">
                                <FaCreditCard className="icon" /> Bank Information
                            </h3>
                            <div className="form-card-content">
                                <div className="form-grid">
                                    {renderField("Bank Name", "bankName", "text", "Enter bank name", FaUniversity)}
                        ...
                        <div className="image-upload-card">
                            ...
                            <div className="image-preview">
                                {addressProofImagePreview ? (
                                    <img src={addressProofImagePreview} alt="Address Proof Preview" />
                                ) : (
                                    <div className="placeholder">
                                        <FaImage size={48} />
                                        <span>No image selected</span>
                            ...
                            <div className="image-upload-card">
                                ...
                                <div className="image-preview">
                                    {utilityBillImagePreview ? (
                                        <img src={utilityBillImagePreview} alt="Utility Bill Preview" />
                                    ) : (
                                        <div className="placeholder">
                                            <FaImage size={48} />
                                            <span>No image selected</span>
