      ...
      <div className="Vadmin-inner-container">
        <div className="admin-card">
          ...
          <div className="admin-details">
            ...
            <p>
              <FaCheckCircle style={{ color: "var(--primary-color)" }} /> <strong>Email Verified At:</strong>{" "}
              {admin.email_verified_at
                ? new Date(admin.email_verified_at).toLocaleString()
                : "Not verified"}
            </p>
            <p><FaCalendarAlt style={{ color: "var(--primary-color)" }} /> <strong>Created At:</strong> {new Date(admin.created_at).toLocaleString()}</p>
            <p><FaBuilding style={{ color: "var(--primary-color)" }} /> <strong>Company ID:</strong> {admin.company_id || admin.roles?.[0]?.company_id || "Not available"}</p>
          </div>
        </div>
