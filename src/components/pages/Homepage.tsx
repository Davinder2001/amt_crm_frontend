  ...
  return (
    ...
    <div className="homepage">
      ...
      <header className="header2">
        <div className="logo">
          <a href="#"><img src={homelogo.src} alt="Logo" />
          <span>Asset Management Technology</span></a>
        </div>
        <nav className="nav">
          <a href="#">Home</a>
          <a href="#">Company</a>
      ...
      <section className="hero">
        <div className="hero-left">
          ...
          <div className="hero-actions">
            ...
            <button className="btn-outline ">Try The Deshboard</button>
          </div>
        </div>
...
<footer className="footer-section">
  <div className="footer-top outer-div">
    ...
    <div className="footer-logo">
          ...
          <a href="#"><img src={footerlogoimage.src} alt="Logo" />
          <span>Asset Management Technology</span></a>
          </div>
        </div>
        </div>
